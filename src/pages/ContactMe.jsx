...
function ContactMe() {
  return (
    <div className="w-full mt-24 md:mt-12 flex flex-col p-3 bg-blue-50">
      <div className="flex">
        <img
      ...
      <div className="w-full font-extrabold flex jsutify-evenly mb-8 flex-col sm:flex-row">
        ...
        <div className="w-full m-2 p-4 flex flex-col items-center align-middle rounded-lg bg-blue-100 shadow-md">
          ...
          EMAIL ME @ <br />
          <span className="text-blue-500">maheshbarapatre14@gmail.com</span>
        </div>
        <div className="w-full m-2 p-4 flex flex-col items-center align-middle rounded-lg bg-blue-100 shadow-md">
          <MdAddCall size={35} />
          CONTACT ME @ <br />
          <span className="text-blue-500">(+91)-9039179882</span>
        </div>
      </div>
    </div>
  );
